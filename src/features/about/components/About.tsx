...
const achievements = [
  {
    ...
    detail:
      "চাঁদপুরের মির্জাপুর উপজেলা থেকে টেক পান্নো আয়োজিত মানবিক সচেতনতা মূলক ২০২৫ এর কিছু ছবি।",
  },
  {
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <Reveal variant="fade-left">
              <div className="h-full rounded-3xl border-2 border-primary/20 bg-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-relaxed text-ink-soft">
                  টেক পান্নো মিশনঃ শিক্ষার্থীদের প্রযুক্তির সঠিক ব্যবহার, সাইবার
            ...
            <Reveal variant="fade-right" delay={150}>
              <div className="h-full rounded-3xl border-2 border-primary/20 bg-white p-8 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-relaxed text-ink-soft">
                  টেক পান্নো প্রযুক্তির সঠিক ব্যবহার, সাইবার নিরাপত্তা সম্পর্কে
              ...
              <div className="rounded-3xl border-2 border-primary/20 bg-white p-8 shadow-sm">
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-2 text-sm text-ink-soft">
                    টেক পান্নো বিভিন্ন শিক্ষা প্রতিষ্ঠান ও মানবিক কর্মকাণ্ডে
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-2 text-sm text-ink-soft">
                    টেক পান্নো-এর বিভিন্ন শিক্ষা প্রতিষ্ঠান ও মানবিক কর্মকাণ্ডে
          ...
          <div className="mx-auto mt-4 max-w-3xl">
            <Reveal variant="fade-up">
              <p className="mb-8 text-center text-sm leading-relaxed text-ink-soft sm:text-base">
                টেক পান্নো-র বিভিন্ন সার্টিফিকেশন ও প্রশিক্ষণ কার্যক্রম স্থানীয়
