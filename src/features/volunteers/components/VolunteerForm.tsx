...
import { useVolunteerConfig } from "@/features/volunteers/hooks/useVolunteerConfig";
          ...
          {step === 0 && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-semibold text-ink">
                    Mobile Number (মোবাইল নম্বর - নিজ/গার্ডিয়ান){" "}
                    <span className="text-secondary">*</span>
                  </label>
                  <input
                    type="tel"
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                {watchPaidBy !== "Cash" && (
                  <div>
                    <label className="mb-1.5 block text-sm font-semibold text-ink">
                      Transaction ID{" "}
                      {watchPaidBy === "bKash" || watchPaidBy === "Nagad" ? (
                        <span className="text-secondary">*</span>
                      ) : null}
                    </label>
                    <input
