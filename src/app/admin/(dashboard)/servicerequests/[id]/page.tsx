...
import ServiceRequestDetail from "@/features/admin/components/ServiceRequestDetail";
...
export default function ServiceRequestDetailPage() {
  ...
  const {
    ...
    queryKey: ["table", "servicerequests", id],
    queryFn: () => api.get<Record<string, unknown>>("servicerequests", id),
  });
  ...
  return <ServiceRequestDetail row={row} config={tables.servicerequests} />;
}
