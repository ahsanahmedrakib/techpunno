    ...
    <div className="relative flex min-h-svh items-center justify-center overflow-hidden bg-cream px-4 py-20">
      ...
      >
        <motion.div variants={fadeUp} className="flex justify-center">
          <span className="relative h-16 w-16 overflow-hidden rounded-2xl shadow-lg shadow-primary/20 ring-2 ring-primary/20">
            <Image
              src={site.logo}
              alt={`${site.name} logo`}
              fill
        ...
        <motion.p
          variants={fadeUp}
          className="mt-8 text-8xl font-extrabold leading-none tracking-tight sm:text-9xl"
        >
        ...
        <motion.p
          variants={fadeUp}
          className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ink-soft sm:text-base"
        >
